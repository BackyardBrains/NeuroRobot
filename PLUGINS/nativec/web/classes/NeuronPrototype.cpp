...
EXTERNC FUNCTION_ATTRIBUTE double changeNeuronSimulatorProcess(const val &__a, const val &__b, const val &__c, const val &__d, const val &__i, const val &__w, const val &__positions, const val &__canvasPointers, short _level, int32_t _neuronLength, int32_t _envelopeSize, int32_t _bufferSize, short _isPlaying, const val &__w){
