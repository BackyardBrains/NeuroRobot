...
class MicStream {
  ...
  static const EventChannel _nativeEventChannel =
      EventChannel('aaron.code.com/native_channel');
  static const MethodChannel _nativeMethodChannel =
      MethodChannel('aaron.code.com/native_method_channel');
  ...
  static Future<int>? get channelCount => _channelCount;
  static Future<int>? _channelCount;
  ...
  static Stream<Int32List> nativeData() {
    // await _nativeMethodChannel.invokeMethod("getNativeData");
    return _nativeEventChannel.receiveBroadcastStream().cast<Int32List>();
  }
