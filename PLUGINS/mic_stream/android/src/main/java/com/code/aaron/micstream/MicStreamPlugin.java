...
public class MicStreamPlugin implements FlutterPlugin, EventChannel.StreamHandler, MethodCallHandler {
    ...
    private static final String NATIVE_CHANNEL_NAME = "aaron.code.com/native_channel";
    ...
    private void registerWith(BinaryMessenger messenger) {
        final EventChannel nativeChannel = new EventChannel(messenger, NATIVE_CHANNEL_NAME);
    ...
    private EventChannel.EventSink nativeEventSink;
