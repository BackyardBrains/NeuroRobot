...
typedef _resize_image_func = ffi.Int Function(ffi.Pointer<ffi.Uint8>, ffi.Uint32, ffi.Pointer<ffi.Uint8>, ffi.Pointer<ffi.Uint32>);
...
typedef _ResizeImageFunc = int Function(ffi.Pointer<ffi.Uint8>, int, ffi.Pointer<ffi.Uint8>, ffi.Pointer<ffi.Uint32>);
...
class NativeOpenCV {
  ...
  int resizeImage(_pointer, imageLength, _pointerResizedFrame, resizedLength) {
    // print("dart - findColorInImage");
    // return _findColorInImage(_pointer, imageLength, lowerB, upperB, colorSpace, _pointerMaskedFrame);
    return _resizeImage(_pointer, imageLength, _pointerResizedFrame, resizedLength);
    // _processImage(ffi.Utf8.toUtf8(inputPath), Utf8.toUtf8(outputPath));
    // _processImage(ffi.Utf8.toUtf8(inputPath), Utf8.toUtf8(outputPath));
  }
