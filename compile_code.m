...
output_dir = strcat('C:\Users\Christopher Harris\NeuroRobot\', app_name, '\compiled');
...
compiler.package.installer(compiler_results, 'ApplicationName', app_name, ...
    ...
    'Summary','User-friendly brain simulator for educational neurorobotics', ...
    'Version', '1.0', 'RuntimeDelivery','web');
