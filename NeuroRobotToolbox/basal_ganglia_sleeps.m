...
% load(strcat(localdata_dir_name, 'livingroom_net'))
% load(strcat(localdata_dir_name, 'livingroom_labels'))
...
%% States
get_states
save(strcat(localdata_dir_name, 'states'), 'states')

load(strcat(localdata_dir_name, 'states'))
...
%% Torques
get_torques
save(strcat(localdata_dir_name, 'torque_data'), 'torque_data')

load(strcat(localdata_dir_name, 'torque_data'))
...
save(strcat(localdata_dir_name, 'actions'), 'actions')

load(strcat(localdata_dir_name, 'actions'))
figure(7)
...
save(strcat(localdata_dir_name, 'mdp'), 'mdp')
load(strcat(localdata_dir_name, 'mdp'))
disp('Markov ready')
...
save(strcat(localdata_dir_name, 'rmdp'), 'mdp')
load(strcat(localdata_dir_name, 'rmdp'))
disp('Rewards ready')
...
ylabel('State')
xlabel('Next State')
export_fig(horzcat(localdata_dir_name, 'mdp_', num2str(date)), '-r150', '-jpg', '-nocrop')


%% Train agents
env = rlMDPEnv(mdp);
save(strcat(localdata_dir_name, 'env'), 'env')
load(strcat(localdata_dir_name, 'env'))
...
export_fig(horzcat(localdata_dir_name, 'AgentTV'), '-r150', '-jpg', '-nocrop')
save(horzcat(localdata_dir_name, 'AgentTV'), 'agent')
...
title('DeepAgentTV')
set(gca, 'xtick', [], 'ytick', [], 'xcolor', 'w', 'ycolor', 'w')
export_fig(horzcat(localdata_dir_name, 'DeepAgentTV'), '-r150', '-jpg', '-nocrop')
save(horzcat(localdata_dir_name, 'DeepAgentTV'), 'agent')
