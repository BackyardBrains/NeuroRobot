...
%         if rand < 0.05
        ...
        if rand < 0.5           
            if ce <= 0.15
                this_weight = 15 + 15 * rand;
            elseif ce < 0.75
                if rand < 1
                    this_weight = -(10 + (10 * rand));
                end
            end
            ...
            connectome(postsynaptic_neuron, presynaptic_neuron) = this_weight;
            da_connectome(postsynaptic_neuron, presynaptic_neuron, 1) = 0;
