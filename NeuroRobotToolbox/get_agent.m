...
load('livingroom_slam_net')
load('livingroom_slam_labels')
...
save(strcat(rl_dir_name, 'image_dir'), 'image_dir')
load(strcat(rl_dir_name, 'image_dir'))
save(strcat(rl_dir_name, 'torque_dir'), 'torque_dir')
load(strcat(rl_dir_name, 'torque_dir'))
...
export_fig(horzcat(rl_dir_name, 'AgentTV'), '-r150', '-jpg', '-nocrop')
save(horzcat(rl_dir_name, 'AgentTV'), 'agent')
...
title('DeepAgentTV')
set(gca, 'xtick', [], 'ytick', [], 'xcolor', 'w', 'ycolor', 'w')
export_fig(horzcat(rl_dir_name, 'DeepAgentTV'), '-r150', '-jpg', '-nocrop')
save(horzcat(rl_dir_name, 'DeepAgentTV'), 'agent')
