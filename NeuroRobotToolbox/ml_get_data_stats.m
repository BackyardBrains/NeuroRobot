...
bof_branching = round((0.001 * ntuples + 200) * alearn_speed);
nmedium = round((0.02 * ntuples + 2000) * alearn_speed);
init_n_unique_states = round(0.001 * ntuples * alearn_speed) + 10;
min_size = round(0.0002 * ntuples * alearn_speed) + 10;
