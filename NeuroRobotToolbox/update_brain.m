...
if nneurons
    ...
    dist_I(dist_prefs == 1) = sigmoid(this_distance, 4, -0.8) * 50;
    dist_I(dist_prefs == 2) = sigmoid(this_distance, 6, -0.8) * 50;
    dist_I(dist_prefs == 3) = sigmoid(this_distance, 8, -0.8) * 50;
