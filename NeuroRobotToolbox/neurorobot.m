...
clf
set(fig_startup, 'NumberTitle', 'off', 'Name', 'SpikerBot 6.1')
set(fig_startup, 'menubar', 'none', 'toolbar', 'none')
set(fig_startup, 'position', startup_fig_pos, 'color', fig_bg_col)

% Title
text_title = uicontrol('Style', 'text', 'String', 'SpikerBot 6.1', 'units', 'normalized', 'position', [0.05 0.7 0.9 0.25], ...
...
% Nets
option_nets = {'GoogLeNet', 'Robots R-CNN', 'xyoNet'}; % Imported nets
