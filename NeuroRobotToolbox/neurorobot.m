...
bg_brain = 1;
script_names = {'Red LEDs', 'Green LEDs', 'Blue LEDs', 'LEDs off', 'Agent', 'CPP'};
...
clf
set(fig_startup, 'NumberTitle', 'off', 'Name', 'SpikerBot 7.0')
set(fig_startup, 'menubar', 'none', 'toolbar', 'none')
set(fig_startup, 'position', startup_fig_pos, 'color', fig_bg_col)

% Title
text_title = uicontrol('Style', 'text', 'String', 'SpikerBot 7.0', 'units', 'normalized', 'position', [0.05 0.7 0.9 0.25], ...
