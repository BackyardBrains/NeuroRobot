...
ml_custom_button = uicontrol('Style', 'pushbutton', 'String', 'Train XYO net', 'Callback', 'ml_xyo_net', 'units', 'normalized', 'position', ml_11_advanced_button_pos, 'FontSize', bfsize + 4, 'fontname', gui_font_name, 'fontweight', gui_font_weight, 'BackgroundColor', [0.8 0.8 0.8]);
