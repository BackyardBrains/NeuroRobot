    ...
    elseif neuron_or_network == 2
        ...
        if sqrt(mouse_location(1,1)^2 + mouse_location(1,2)^2) < 2.2
            ...
            if ~cpg_integration % Random CPG build
                ...
                text_w1 = uicontrol('Style', 'text', 'String', 'Brain library', 'units', 'normalized', 'position', [0.02 0.86 0.21 0.05], 'backgroundcolor', fig_bg_col, 'fontsize', bfsize, 'horizontalalignment', 'left', 'fontname', gui_font_name, 'fontweight', gui_font_weight);
