...
% Add RL Agents
button_add_agents = uicontrol('Style', 'pushbutton', 'String', 'Agent', 'units', 'normalized', 'position', button4_pos, 'fontname', gui_font_name, 'fontweight', gui_font_weight);
...
set(button_add_agents, 'enable', 'off')
