...
% Create random brain
button_add_algorithm = uicontrol('Style', 'pushbutton', 'String', 'Randomize', 'units', 'normalized', 'position', button3_pos, 'fontname', gui_font_name, 'fontweight', gui_font_weight);
