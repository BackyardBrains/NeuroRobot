...
export_fig(horzcat('agent1_rand_', 'net'), '-r150', '-jpg', '-nocrop')
save(horzcat('agent1_rand_'), 'agent')
...
title('Agent 2 rand')
set(gca, 'xtick', [], 'ytick', [], 'xcolor', 'w', 'ycolor', 'w')
export_fig(horzcat('agent2_rand_', 'net'), '-r150', '-jpg', '-nocrop')
save(horzcat('agent2_rand_'), 'agent')
