...
export_fig(horzcat('agent_3_', num2str(date), '_mdp'), '-r150', '-jpg', '-nocrop')
...
export_fig(horzcat('agent_3_', num2str(date), '_net'), '-r150', '-jpg', '-nocrop')
save('agent_3', 'agent')
...
title('Agent 33')
set(gca, 'xtick', [], 'ytick', [], 'xcolor', 'w', 'ycolor', 'w')
export_fig(horzcat('agent_33_', num2str(date), '_net'), '-r150', '-jpg', '-nocrop')
save('agent_33', 'agent')
