...
//  // Send distance data to Matlab (v2)
//  digitalWrite(ultrasonicTrigPin, LOW);
//  delayMicroseconds(2);
//  digitalWrite(ultrasonicTrigPin, HIGH);
//  delayMicroseconds(10);
...
//  ultrasonicDistance = tempUltrasonicDistance * 0.034 / 2; // Speed of sound wave divided by 2 (go and back)

// Send distance data to Matlab (v3)
    digitalWrite(ultrasonicTrigPin, LOW);
  delayMicroseconds(5);
  digitalWrite(ultrasonicTrigPin, HIGH);
  delayMicroseconds(10);
