...
"""Add Attestation Authority public key command."""
...
class Add(base.Command):
  """Add a public key to an Attestation Authority."""
  ...
  def Run(self, args):
    ...
    return authorities_client.AddKey(
        authority_ref, args.public_key_file, args.comment)
