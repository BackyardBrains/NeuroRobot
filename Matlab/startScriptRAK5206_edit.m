...
text_serial_send = uicontrol('Style', 'text', 'String', 'Send', 'units', 'normalized', 'position', [0.1 0.05 0.1 0.05], 'FontName', 'Comic Book', 'fontsize', 18, 'horizontalalignment', 'center');
text_serial_receive = uicontrol('Style', 'text', 'String', 'Receive', 'units', 'normalized', 'position', [0.65 0.05 0.3 0.05], 'FontName', 'Comic Book', 'fontsize', 18, 'horizontalalignment', 'center');
...
%     text_serial_send.String = horzcat('Sent: ', this_send);   
