...
b_y = 0.04;
b_x = 0.1433;
button_design = uicontrol('Style', 'pushbutton', 'String', 'Design', 'units', 'normalized', 'position', [0.02 0.02 b_x b_y]);
...
button_save = uicontrol('Style', 'pushbutton', 'String', 'Save', 'units', 'normalized', 'position', [0.1833 0.02 b_x b_y]);
...
button_pause = uicontrol('Style', 'pushbutton', 'String', 'Restart', 'units', 'normalized', 'position', [0.3466 0.02 b_x b_y]);
...
button_stop = uicontrol('Style', 'pushbutton', 'String', 'Stop', 'units', 'normalized', 'position', [0.5099 0.02 b_x b_y]);
...
button_stop = uicontrol('Style', 'pushbutton', 'String', 'Annotate', 'units', 'normalized', 'position', [0.6732 0.02 b_x b_y]);
set(button_stop,'Callback', 'run_button = 6;', 'FontSize', bfsize, 'fontname', gui_font_name, 'fontweight', gui_font_weight, 'BackgroundColor', [0.8 0.8 0.8])

button_reward = uicontrol('Style', 'pushbutton', 'String', 'Dopamine', 'units', 'normalized', 'position', [0.8365 0.02 b_x b_y]);
