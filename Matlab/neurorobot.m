...
% NEUROROBOT APP
% By Backyard Brains, backyardbrains.com
% Correspondence to Christopher Harris, christopher@backyardbrains.com
% This code is licenses under a Creative Commons license (CC BY 4.0, creativecommons.org/licenses/by/4.0/)
...
ext_cam_id = 0; % 1 is usually the laptop's own webcam, 2 any attached USB webcamera
ext_cam_nsteps = 100; % is this how many frames are recorded before stop or repeat?
manual_controls = 0;
use_profile = 0;
nsteps_per_loop = 100;
brain_facts = 0;
use_cnn = 0;
pulse_period = 0.1; % in sec
max_w = 30;
large_brain = 0;
...
%% Constants
base_weight = max_w;
learning_rate = 0.05; % not in use from 9 Jan 2019
left_cut = [1 500 281 780]; % Part of 1280x720 camera frame used for left eye
right_cut = [1 500 501 1000]; % Part of 1280x720 camera frame used for right eye
