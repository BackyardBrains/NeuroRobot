...
brain(1).file_name = '2019-08-07-05-11-52-1152-Signet';
brain(2).file_name = '2019-08-07-05-11-54-1154-Moinet';
...
disp(horzcat('Brain 1 to phone lag = ', num2str(brain_to_phone_lag)))
...
%% Get video
tic
start_time_in_sec = -(brain_to_phone_lag / 8000) + 1.4;
