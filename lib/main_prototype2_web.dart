...
//   Int32List npsBufView  = Int32List(0);
...
//     widgets.add( Text("Neurons / second : ${formatter.format(secondXNeurons)}", textAlign: TextAlign.end , style: const TextStyle(fontWeight: FontWeight.bold)) );
