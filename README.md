...
<br>
<b>Installation</b><br>
To install the SpikerBot app on a Windows PC, download this repository, unpack SpikerBot_4.5_Installer.zip, and run the installer SpikerBot_4.5_Installer.exe. Because this is an unsigned app, you will need to navigate a blue warning message by clicking 'More info' then 'Run Anyway' in order to install the app. The app also runs natively in Matlab on all platforms.<br>
<br>
